...
@Component({
  selector: 'ngx-lmcipolletti-facebook',
  styleUrls: ['./lmcipolletti-facebook.component.scss'],
  templateUrl: './lmcipolletti-facebook.component.html',
})
export class LmcipollettiFacebookComponent implements OnInit{
