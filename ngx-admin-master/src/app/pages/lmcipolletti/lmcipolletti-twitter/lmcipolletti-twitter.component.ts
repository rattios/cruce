...
@Component({
  selector: 'ngx-lmcipolletti-twitter',
  styleUrls: ['./lmcipolletti-twitter.component.scss'],
  templateUrl: './lmcipolletti-twitter.component.html',
})
export class LmcipollettiTwitterComponent implements OnInit{
