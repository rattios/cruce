...
@Component({
  selector: 'ngx-lmcipolletti-instagram',
  styleUrls: ['./lmcipolletti-instagram.component.scss'],
  templateUrl: './lmcipolletti-instagram.component.html',
})
export class LmcipollettiInstagramComponent implements OnInit{
