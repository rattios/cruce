...
let fbLoginOptions: LoginOpt = {
  scope: 'user_posts,user_likes,user_about_me,user_birthday,user_friends,user_location,user_website,publish_pages,pages_messaging,pages_messaging_subscriptions,email,read_stream',
  return_scopes: true,
