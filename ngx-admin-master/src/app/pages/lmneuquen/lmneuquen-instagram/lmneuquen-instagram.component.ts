...
@Component({
  selector: 'ngx-lmneuquen-instagram',
  styleUrls: ['./lmneuquen-instagram.component.scss'],
  templateUrl: './lmneuquen-instagram.component.html',
})
export class LmneuquenInstagramComponent implements OnInit{
